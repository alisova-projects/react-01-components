...
- [create-react-app](https://create-react-app.dev/)
  - webpack - собрать JS
  - babel - чтобы транспайлить это всё, мы хотим писать современный JS и
    какие-то специализированные конструкции в React, и получать обычный JS,
    который может скучашь браузер
  - eslint - чтобы проверять эти все вещи, линтить наш код
  - react - пакетик
  - react-dom - пекетик
- React-элементы и `React.createElement()`
  ...
  - Пропсы
  - children
- JSX как шаблонизатор (JS Extention - расширение JS) - JSX-выражение используем
  чтобы передать значение атрибутам
